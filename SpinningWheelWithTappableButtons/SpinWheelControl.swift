...
open class SpinWheelControl: UIControl {
    ...
    var spinWheelView: PassThroughView!
    ...
    override open func endTracking(_ touch: UITouch?, with event: UIEvent?) {
        print("ended")
        if !isSpinning{
            print("trying to get the buttons click")
            print(spinWheelView.point(inside: (touch?.location(in: self))!, with: event))
            print("Above is a bool. How to make this a UIButton?")
        }
        isSpinning = false
